                ...
                const headerActions = (
                  <>
                    ...
                    {onCategoryReviewHardCards && (() => {
                       ...
                       return (
                         <button
                           onClick={(e) => { e.stopPropagation(); hardCardsInCat.length > 0 && onCategoryReviewHardCards(subject, subjectDecks); }}
                           disabled={hardCardsInCat.length === 0}
                           className={cn(
                           ...
                           title={`Ôn ${hardCardsInCat.length} thẻ khó`}
                         >
                           <span className="flex items-center justify-center bg-white/20 rounded-full w-4 h-4 text-[9px]">{hardCardsInCat.length}</span>
