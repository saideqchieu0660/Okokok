                              ...
                              return (
                                <div key={subject} className="border border-zinc-150 dark:border-zinc-800/80 rounded-xl overflow-hidden bg-zinc-50/30 dark:bg-zinc-900/10">
                                  ...
                                  <button
                                    ...
                                    className="sticky top-16 sm:top-20 z-20 w-full flex items-center justify-between p-3.5 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition text-left cursor-pointer"
                                  >
                                    <div className="flex items-center gap-3">
